...
export default function OnboardingModal({
  ...
  const [data, setData] = useState<
    ProfileData & { business_type_other: string }
  >({
    business_type: "",
    business_type_other: "",
    niche: "",
  ...
  const canSubmit = () => {
    ...
    return hasBusinessType && data.niche.trim() && data.target_audience.trim();
  };
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center rounded-lg overflow-y-auto py-8 min-h-[800px]">
      {/* Backdrop */}
      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" />

      {/* Modal */}
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 p-6 my-auto">
        {/* Header */}
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Tell us about your business so we can create better content (takes
            30 seconds)
          </p>
        </div>
